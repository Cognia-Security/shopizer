...
public class UserServicesImpl implements WebUserServices{
	...
	private static final String DEFAULT_INITIAL_PASSWORD =
			System.getenv("DEFAULT_ADMIN_PASSWORD") != null
					? System.getenv("DEFAULT_ADMIN_PASSWORD")
					: "password";
	
	// VULNERABILITY: exposes default password through public API
	public String exposeDefaultAdminPassword() {
